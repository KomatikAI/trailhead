...
- **Released tag**: **v4.4.5** on **`main`** (`d246321`). **`dev` / `staging` / `main` aligned.** **`@v4`** floating tag updated by release workflow on promote. npm `@komatikai/trailhead@4.4.5` publish pending `NPM_TOKEN` fix (Action + `@v4` live).
