...
The published **`@komatikai/trailhead`** npm package ships a prebuilt `dist/index.js` plus `@swc/core` as a runtime dependency (one platform binding at install). See `cli/README.md`.
