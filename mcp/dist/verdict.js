...
export const TRAILHEAD_VERDICT_SCHEMA = "trailhead.verdict.v1";
export const PENALTY_SEMANTICS = "lower_is_cleaner";
export const RISK_SEMANTICS = "higher_is_worse";
...
export const TrailheadVerdictSchema = z.object({
    ...
    submission_checks: z.array(z.object({
...
export function computeSubmissionPenalty(checks = []) {
    const factor_scores = {};
...
export function collectVerdictReasons(evaluation) {
...
export function buildGateVerdict(evaluation, options = {}) {
...
export function parseGateVerdict(raw) {
    try {
...
export function aggregateVerdictPenaltyQuality(verdicts) {
...
export function projectVerdictToTrustCorrelation(verdict) {
    return {
